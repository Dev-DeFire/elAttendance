...
public class EmployeesModelClass {
    ...
    public EmployeesModelClass() {
    }

    public EmployeesModelClass(String name, String email, String id, String organization, String empUid, String phone, String embeddings, String admin, String father, String bloodGrp, String startDate) {
        this.name = name;
        this.email = email;
        this.id = id;
